class ConnectionPoint {
	...
	*/
	public setValue(newValue: any, updateNode: boolean = false, updateInlets: boolean = false, otherType: DataType = null): void {
		...
		else if (this.side == IOSide.Input && this.hasLink()) type = this.link.getType();
