...
* @author Orlando
*/
export class TypeImage extends DataType {
...
export type ImageTransformationFunction = (canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, img: HTMLImageElement) => void;